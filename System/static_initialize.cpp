...
TArray<CStaticInitializer*>
    CStaticInitializer::s_pInitializers[(unsigned long long)EPriority::NUM];
...
STATIC_INTIALIZE(log_priority_first, FIRST) { Msg("Static Initializer Priority 1"); }

STATIC_INTIALIZE(log_priority_second, SECOND) {
    Msg("Static Initializer Priority 2");
}

STATIC_INTIALIZE(log_priority_third, THIRD) { Msg("Static Initializer Priority 3"); }