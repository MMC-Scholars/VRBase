...
AWorldButton::AWorldButton() {
  m_pMeshComponent =
      CreateDefaultSubobject<UStaticMeshComponent>("Button Mesh");
  ...
  m_pMeshComponent->OnComponentEndOverlap.AddDynamic(
      this, &AWorldButton::OnOverlapEnd);
}
...
void AWorldButton::OnOverlapBegin(UPrimitiveComponent *OverlappedComp,
                                  AActor *OtherActor,
  ...
  if (OtherActor && dynamic_cast<ABaseController *>(OtherActor)) {
    ...
    // play sound
    UGameplayStatics::PlaySoundAtLocation(this, m_pOnPressCue,
                                          GetActorLocation());
...
void AWorldButton::OnOverlapEnd(UPrimitiveComponent *OverlappedComp,
                                AActor *OtherActor,
                                UPrimitiveComponent *OtherComp,
