...
public:
  // bool								IsBaseEntity()					const	{ return
  // GetActor()->ActorHasTag(TAG_BASEENTITY); }
...
public:
  bool Use(ABaseEntity *
           pActivator); // returns true on success, false if blocked
