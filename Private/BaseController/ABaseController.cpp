...
#include "BasePawn/ABasePawn.h"
#include "MoveLinear/AMoveLinear.h"
...
ABaseController::ABaseController() {
	...
	// Depth, Height, Width
	FVector cornerBBL = FVector(CONTROLLER_DEFAULT_MESH_SIZE / -2, CONTROLLER_DEFAULT_MESH_SIZE / -2, CONTROLLER_DEFAULT_MESH_SIZE / -2);
	FVector cornerBBR = FVector(CONTROLLER_DEFAULT_MESH_SIZE / 2, CONTROLLER_DEFAULT_MESH_SIZE / -2, CONTROLLER_DEFAULT_MESH_SIZE / -2);
	FVector cornerBTL = FVector(CONTROLLER_DEFAULT_MESH_SIZE / -2, CONTROLLER_DEFAULT_MESH_SIZE / -2, CONTROLLER_DEFAULT_MESH_SIZE / 2);
	FVector cornerBTR = FVector(CONTROLLER_DEFAULT_MESH_SIZE / 2, CONTROLLER_DEFAULT_MESH_SIZE / -2, CONTROLLER_DEFAULT_MESH_SIZE / 2);
	FVector cornerFBL = FVector(CONTROLLER_DEFAULT_MESH_SIZE / -2, CONTROLLER_DEFAULT_MESH_SIZE / 2, CONTROLLER_DEFAULT_MESH_SIZE / -2);
	FVector cornerFBR = FVector(CONTROLLER_DEFAULT_MESH_SIZE / 2, CONTROLLER_DEFAULT_MESH_SIZE / 2, CONTROLLER_DEFAULT_MESH_SIZE / -2);
	FVector cornerFTL = FVector(CONTROLLER_DEFAULT_MESH_SIZE / -2, CONTROLLER_DEFAULT_MESH_SIZE / 2, CONTROLLER_DEFAULT_MESH_SIZE / 2);
	FVector cornerFTR = FVector(CONTROLLER_DEFAULT_MESH_SIZE / 2, CONTROLLER_DEFAULT_MESH_SIZE / 2, CONTROLLER_DEFAULT_MESH_SIZE / 2);
