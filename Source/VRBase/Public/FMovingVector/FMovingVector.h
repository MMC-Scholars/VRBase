 ...
 * Velocities can be  modified at any time (starting in AActor::BeginPlay() and from 
 * any tick or think function)
 * These are all destroyed in AGameRules::EndPlay(), but it is also safe to delete 
 * them during Tick or Think functions
 *-------------------------------------------------------------------------------------
 */
