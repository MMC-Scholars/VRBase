...
class VRBASE_API ASign : public ABaseEntity {
	...
	public:
		...
		virtual void OnConstruction(const FTransform& Transform) override { TextReload(); };
	...
	public:		
		...
		UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Text", DisplayName = "Horizontal Align")
		TEnumAsByte<EHorizTextAligment> m_eAlignX;

		UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Text", DisplayName = "Vertical Align")
		TEnumAsByte<EVerticalTextAligment> m_eAlignY;

		UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Text", DisplayName = "Text Color")
		FColor m_sColor;

		UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Rendering", DisplayName = "Mesh Material")
